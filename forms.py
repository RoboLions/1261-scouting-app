...
class ChargedUpForm(FlaskForm):
    ...
    cone_auto_top = IntegerField ("Cone Auto - Top", default = 0, validators=[DataRequired(), NumberRange(0, 6)])
    cone_auto_middle = IntegerField("Cone Auto - Middle", default = 0, validators=[DataRequired(), NumberRange(0, 6)])
    cone_auto_hybrid= IntegerField("Cone Auto - Hybrid", default = 0, validators=[DataRequired(), NumberRange(0, 9)])

    cube_auto_top = IntegerField ("Cube Auto - Top", default = 0, validators=[DataRequired(), NumberRange(0, 3)])
    cube_auto_middle = IntegerField("Cube Auto - Middle", default = 0, validators=[DataRequired(), NumberRange(0, 3)])
    cube_auto_hybrid= IntegerField("Cube Auto - Hybrid", default = 0, validators=[DataRequired(), NumberRange(0, 9)])

    cone_teleop_top = IntegerField ("Cone Teleop - Top", default = 0, validators=[DataRequired(), NumberRange(0, 6)])
    cone_teleop_middle = IntegerField("Cone Teleop - Middle", default = 0, validators=[DataRequired(), NumberRange(0, 6)])
    cone_teleop_hybrid= IntegerField("Cone Teleop - Hybrid", default = 0, validators=[DataRequired(), NumberRange(0, 9)])

    cube_teleop_top = IntegerField ("Cube Teleop - Top", default = 0, validators=[DataRequired(), NumberRange(0, 3)])
    cube_teleop_middle = IntegerField("Cube Teleop - Middle", default = 0, validators=[DataRequired(), NumberRange(0, 3)])
    cube_teleop_hybrid= IntegerField("Cube Teleop - Hybrid", default = 0, validators=[DataRequired(), NumberRange(0, 9)])
